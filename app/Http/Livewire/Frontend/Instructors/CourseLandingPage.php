...
class CourseLandingPage extends Component
{
    ...
    // protected $messages = [
    //     'title.required' => 'transf.title.required',
    //     'title.min' => 'transf.title.min',
    //     'title.max' => 'transf.title.max',
    //     'subtitle.required' => 'transf.subtitle.required',
    //     'subtitle.min' => 'transf.subtitle.min',
    //     'subtitle.max' => 'transf.subtitle.max',
    //     'images.*.required' => 'transf.images.required',
    //     'images.*.image' => 'transf.images.image',
    //     'images.*.max' => 'transf.images.max',
    //     'video_promo.url' => 'transf.video_promo.url',
    //     'video_promo.max' => 'transf.video_promo.max',
    //     'video_description.url' => 'transf.video_description.url',
    //     'video_description.max' => 'transf.video_description.max',
    //     'language.required' => 'transf.language.required',
    //     'language.in' => 'transf.language.in',
    //     'skill_level.required' => 'transf.skill_level.required',
    //     'skill_level.in' => 'transf.skill_level.in',
    //     'course_type.required' => 'transf.course_type.required',
    //     'course_type.in' => 'transf.course_type.in',
    //     'course_category_id.required' => 'transf.course_category_id.required',
    //     'course_category_id.exists' => 'transf.course_category_id.exists',
    //     'certificate.required' => 'transf.certificate.required',
    //     'certificate.boolean' => 'transf.certificate.boolean',
    //     'deadline.date_format' => 'transf.deadline.date_format',
    // ];
