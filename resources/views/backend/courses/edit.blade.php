                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="text" name="sku" id="sku"
                                    value="{{ old('sku', $course->sku) }}" class="form-control">
                                @error('sku')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="number" name="quantity" id="quantity"
                                    value="{{ old('quantity', $course->quantity == -1 ? '' : $course->quantity) }}"
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    <label class="col-form-label col-md-12 col-sm-12 ">
                                        <input class='child' type='checkbox' name="Quantity_Unlimited"
                                            ...
                                            {{ old('Quantity_Unlimited') || $course->quantity == -1 ? 'checked' : '' }} />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="number" name="max_order" id="max_order"
                                    value="{{ old('max_order', $course->max_order == -1 ? '' : $course->max_order) }}"
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    <label class="col-form-label col-md-12 col-sm-12 ">
                                        <input class='child2' type='checkbox' name="Quantity_Unlimited_max_order"
                                            ...
                                            {{ old('Quantity_Unlimited_max_order') | ($course->max_order == -1) ? 'checked' : '' }} />
                                        {{ __('panel.qty_not_limited') }} </label>
                                </div>
