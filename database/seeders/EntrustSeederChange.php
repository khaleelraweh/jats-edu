...
$displayCertificates   =  Permission::create(['name' => 'display_certificates', 'display_name'    =>  ['ar'   =>  'عرض شهادة',              'en'    =>  'Display Certificate'], 'route' => 'certificates', 'module' => 'certificates', 'as' => 'certificates.show', 'icon' => null, 'parent' => $manage->id, 'parent_original' => $manageCertificates->id, 'parent_show' => $manageCertificates->id, 'sidebar_link' => '0', 'appear' => '0']);
