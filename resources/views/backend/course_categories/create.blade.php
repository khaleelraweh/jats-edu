...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    {{ __('panel.add_new_course_category') }}
                </h3>
                <ul class="breadcrumb">
                    <li>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.course_categories.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="{{ $loop->index == 0 ? 'col-md-5' : 'd-none' }} col-sm-12 ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 pt-4">
                                            <label for="category_image" class="control-label ">
                                                {{ __('panel.image') }}
                                                /
                                                {{ __('panel.images') }}
                                            </label>
