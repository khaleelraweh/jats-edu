        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header py-3 d-flex justify-content-between">
                    ...
                    <div class="ml-auto">
                        @ability('admin', 'create_topics_menus')
                            <a href="{{ route('admin.topics_menus.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    {{-- filter form part  --}}
                    @include('backend.topics_menus.filter.filter')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                @ability('admin', 'update_topics_menus')
                                                    <a href="{{ route('admin.topics_menus.edit', $menu->id) }}"
                                                        class="btn btn-primary">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endability
                                                @ability('admin', 'delete_topics_menus')
                                            ...
                                            <form action="{{ route('admin.topics_menus.destroy', $menu->id) }}"
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="float-right">
                                        {!! $topics_menus->appends(request()->all())->links() !!}
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
