...
@section('content')
        ...
        <div class="position-absolute right-0 left-0 top-0 bottom-0">
            <div class="cs-parallax">
                <div class="cs-parallax-layer" data-depth="0.1">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-01.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-02.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-03.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-04.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.4">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-05.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-06.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-07.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-08.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.4">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-09.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('frontend/assets/img/parallax/layer-10.svg') }}" alt="Layer">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-5 col-lg-6 order-md-2" data-aos="fade-in" data-aos-delay="50">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('frontend/assets/img/illustrations/illustration-1.png') }}"
                ...
                <div class="col-12 col-md-7 col-lg-6 order-md-1 px-md-0">
                    ...
                    <!-- Buttons -->
                    <a href="course-list-v1.html" class="btn btn-wide btn-slide slide-primary shadow mb-4 mb-md-0 me-md-5"
                        ...
                        <div class="card-zoom position-relative">
                            ...
                            <a href="course-single-v1.html" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg"
                                    src="{{ asset('frontend/assets/img/products/product-1.jpg') }}" alt="...">
                            </a>
                            ...
                            <div class="position-relative">
                                <a href="course-single-v1.html" class="d-block stretched-link">
                                    <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Fashion
                                        Photography From Professional</h4>
                                </a>
                            ...
                            <div class="position-relative">
                                <a href="course-single-v1.html" class="d-block stretched-link">
                                    <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete
                                        JavaScript Course 2020: Build Real Projects!</h4>
                                </a>
                    ...
                    <div class="card border shadow p-2 sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <a href="#" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg"
                                    src="{{ asset('frontend/assets/img/products/product-3.jpg') }}" alt="...">
                            </a>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <div class="position-relative">
                                <a href="course-single-v1.html" class="d-block stretched-link">
                                    <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Learn Figma:
                                        User Interface Design Essentials - UI/UX Design</h4>
                                </a>
                ...
                <div class="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="card border shadow p-2 sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <a href="course-single-v1.html" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg"
                                    src="{{ asset('frontend/assets/img/products/product-4.jpg') }}" alt="...">
                            </a>
                        </div>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <div class="position-relative">
                                <a href="course-single-v1.html" class="d-block stretched-link">
                                    <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete
                                        Financial Analyst Course 2020</h4>
                                </a>
        ...
        <div class="container">
            <div class="row align-items-end mb-md-7 mb-4" data-aos="fade-up">
                <div class="col-md mb-4 mb-md-0">
                    ...
                    <p class="font-size-lg mb-0 text-capitalize">Cum doctus civibus efficiantur in imperdiet deterruisset.
                    </p>
                </div>
                <div class="col-md-auto">
                ...
                <div class="col-12 col-md-6 col-xl-4 py-md-7 py-3" data-aos="fade-up" data-aos-delay="50"
                    ...
                    <div class="card border shadow p-6 lift-md">
                        ...
                        <div class="card-footer px-0 pb-0">
                            <p class="mb-0 text-capitalize">“ I believe in lifelong learning and Skola is a great place to
                                learn from experts. I've learned a lot and recommend it to all my friends “</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="50">
                    <div class="mw-100p mx-auto">
                        ...
                        <svg viewBox="0 0 100 34" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path fill="#FF9900"
                                d="M74.2,25.3c-6.6,5-16.1,7.7-24.3,7.7c-11.5,0-21.8-4.4-29.7-11.7c-0.6-0.6-0.1-1.4,0.7-0.9
                        ...
                        <svg viewBox="0 0 100 34" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                ...
                                <g>
                                    ...
                                    <path fill="#FEDE3A"
                                        d="M29.3,13.1H13c-0.6,0-1.2-0.3-1.5-0.9c-0.1,0.2-0.2,0.4-0.2,0.6c-0.2,1,0.6,2,1.7,2h16.3
                        ...
                        <div class="row gx-0">
                            ...
                            <a href="event-single.html" class="col-auto d-block mw-md-152" style="max-width: 120px;">
                                <img class="img-fluid rounded shadow-light-lg h-100 o-f-c"
                                    src="{{ asset('frontend/assets/img/events/event-1.jpg') }}" alt="...">
                            </a>
                ...
                <div class="col-lg mb-5 mb-md-6">
                    ...
                    <div class="card border shadow p-2 lift">
                        <div class="row gx-0">
                            ...
                            <a href="event-single.html" class="col-auto d-block mw-md-152" style="max-width: 120px;">
                                <img class="img-fluid rounded shadow-light-lg h-100 o-f-c"
                                    src="{{ asset('frontend/assets/img/events/event-2.jpg') }}" alt="...">
                            </a>
                ...
                <div class="col-lg mb-5 mb-md-6">
                    ...
                    <div class="card border shadow p-2 lift">
                        <div class="row gx-0">
                            ...
                            <a href="event-single.html" class="col-auto d-block mw-md-152" style="max-width: 120px;">
                                <img class="img-fluid rounded shadow-light-lg h-100 o-f-c"
                                    src="{{ asset('frontend/assets/img/events/event-3.jpg') }}" alt="...">
                            </a>
                ...
                <div class="col-lg mb-5 mb-md-6">
                    ...
                    <div class="card border shadow p-2 lift">
                        <div class="row gx-0">
                            ...
                            <a href="event-single.html" class="col-auto d-block mw-md-152" style="max-width: 120px;">
                                <img class="img-fluid rounded shadow-light-lg h-100 o-f-c"
                                    src="{{ asset('frontend/assets/img/events/event-4.jpg') }}" alt="...">
                            </a>
                            ...
                            <div class="col">
                                <div class="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" class="d-block mb-2">
                                        <h5 class="line-clamp-2 h-xl-52 mb-1">Undergraduate Open Day – Holloway Campus - 3
                                            July 2020</h5>
                                    </a>
                ...
                <div class="col-lg mb-5 mb-md-6">
                    ...
                    <div class="card border shadow p-2 lift">
                        <div class="row gx-0">
                            ...
                            <a href="event-single.html" class="col-auto d-block mw-md-152" style="max-width: 120px;">
                                <img class="img-fluid rounded shadow-light-lg h-100 o-f-c"
                                    src="{{ asset('frontend/assets/img/events/event-5.jpg') }}" alt="...">
                            </a>
                            ...
                            <div class="col">
                                <div class="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" class="d-block mb-2">
                                        <h5 class="line-clamp-2 h-xl-52 mb-1">"Introduction to Law" Open Day with Bristows
                                        </h5>
                                    </a>
                ...
                <div class="col-lg mb-5 mb-md-6">
                    ...
                    <div class="card border shadow p-2 lift">
                        <div class="row gx-0">
                            ...
                            <a href="event-single.html" class="col-auto d-block mw-md-152" style="max-width: 120px;">
                                <img class="img-fluid rounded shadow-light-lg h-100 o-f-c"
                                    src="{{ asset('frontend/assets/img/events/event-6.jpg') }}" alt="...">
                            </a>
                            ...
                            <div class="col">
                                <div class="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" class="d-block mb-2">
                                        <h5 class="line-clamp-2 h-xl-52 mb-1">Kingston College undergraduate Open Events
                                            2019-20</h5>
                                    </a>
                        ...
                        <div class="card-zoom position-relative" style="max-width: 250px;">
                            ...
                            <a href="instructors-single.html"
                                class="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img
                                    ...
                                    src="{{ asset('frontend/assets/img/users/instructor-1.jpg') }}" alt="..."></a>
                        </div>
                    ...
                    <div class="card border shadow p-2 lift">
                        ...
                        <div class="card-zoom position-relative" style="max-width: 250px;">
                            ...
                            <a href="instructors-single.html"
                                class="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img
                                    class="rounded shadow-light-lg img-fluid"
                                    src="{{ asset('frontend/assets/img/users/instructor-2.jpg') }}" alt="..."></a>
                        </div>
                    ...
                    <div class="card border shadow p-2 lift">
                        ...
                        <div class="card-zoom position-relative" style="max-width: 250px;">
                            ...
                            <a href="instructors-single.html"
                                class="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img
                                    class="rounded shadow-light-lg img-fluid"
                                    src="{{ asset('frontend/assets/img/users/instructor-3.jpg') }}" alt="..."></a>
                        </div>
                    ...
                    <div class="card border shadow p-2 lift">
                        ...
                        <div class="card-zoom position-relative" style="max-width: 250px;">
                            ...
                            <a href="instructors-single.html"
                                class="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img
                                    class="rounded shadow-light-lg img-fluid"
                                    src="{{ asset('frontend/assets/img/users/instructor-4.jpg') }}" alt="..."></a>
                        </div>
    ...
    <section class="py-6 py-md-11 border-top border-bottom jarallax" data-jarallax data-speed=".8"
        style="background-image: url({{ asset('frontend/assets/img/illustrations/illustration-1.jpg') }})">
