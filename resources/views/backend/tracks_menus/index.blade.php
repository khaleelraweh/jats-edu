        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header py-3 d-flex justify-content-between">
                    <div class="card-naving">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                {{ __('panel.show_tracks_menus') }}
                            </li>
                        </ul>
                    </div>
                    <div class="ml-auto">
                        @ability('admin', 'create_tracks_menus')
                            <a href="{{ route('admin.tracks_menus.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    {{-- filter form part  --}}
                    @include('backend.tracks_menus.filter.filter')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                @ability('admin', 'update_tracks_menus')
                                                    <a href="{{ route('admin.tracks_menus.edit', $menu->id) }}"
                                                        class="btn btn-primary">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endability
                                                @ability('admin', 'delete_tracks_menus')
                                            ...
                                            <form action="{{ route('admin.tracks_menus.destroy', $menu->id) }}"
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="float-right">
                                        {!! $tracks_menus->appends(request()->all())->links() !!}
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
