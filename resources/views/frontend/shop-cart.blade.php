                                        ...
                                        <tbody>
                                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                                ...
                                                <td class="product-quantity" data-title="Quantity">
                                                    ...
                                                    <div class="border rounded d-flex align-items-center">
                                                        <input
                                                            class="form-control form-control-sm border-0 quantity mw-70p px-2"
                                                            min="0" name="quantity" value="1" type="number">
                                                        <div class="d-flex flex-column me-3">
                                                            <button
                                                                class="border-0 shadow-none quantity-plus font-size-10 p-0 bg-transparent outline-0 text-dark">
                                                                <i class="fas fa-chevron-up"></i>
                                                            </button>
                                                            <button
                                                                class="border-0 shadow-none quantity-minus font-size-10 p-0 bg-transparent outline-0 text-dark">
                                                ...
                                                <td class="product-subtotal" data-title="Total">
                                                    <span class="woocommerce-Price-amount amount"><span
                                                            class="woocommerce-Price-currencySymbol">$</span>1298</span>
                                                </td>
                                            ...
                                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                                <td class="product-name" data-title="Product">
                                                    <div class="d-flex align-items-center">
                                                        <a href="shop-single.html">
                                                            <img src="assets/img/products/product-27.jpg"
                                                                class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                                alt="">
                                                        </a>
                                                        <div class="ms-6">
                                            ...
                                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                                <td class="product-name" data-title="Product">
                                                    <div class="d-flex align-items-center">
                                                        <a href="shop-single.html">
                                                            <img src="assets/img/products/product-28.jpg"
                                                                class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                                alt="">
                                                        </a>
                                                        <div class="ms-6">
