...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // // News
        $manageNews = Permission::create(['name' => 'manage_news', 'display_name' => ['ar'  =>  'إدارة المدونات',    'en'    =>  'Manage blogers'], 'route' => 'news', 'module' => 'news', 'as' => 'news.index', 'icon' => 'fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '2000',]);
        $manageNews->parent_show = $manageNews->id;
        $manageNews->save();
        $showNews   =  Permission::create(['name'  => 'show_news', 'display_name'       =>  ['ar'   =>  'يالمنشورات',   'en'    =>  'postes'], 'route' => 'news', 'module' => 'news', 'as' => 'news.index', 'icon' => 'fas fa-newspaper', 'parent' => $manageNews->id, 'parent_original' => $manageNews->id, 'parent_show' => $manageNews->id, 'sidebar_link' => '1', 'appear' => '1']);
