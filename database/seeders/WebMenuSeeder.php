...
class WebMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $design  = WebMenu::create(['title'  => ['ar' => 'التصميم', 'en' => 'Design'], 'icon'   => 'fa fa-home', 'link' =>  'courses/design', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $courses->id]);
        ...
        $web_developer = WebMenu::create(['title'  => ['ar' => 'البرمجة', 'en' => 'Development'], 'icon'   => 'fa fa-home', 'link'  =>  'courses/software-development', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $courses->id]);
