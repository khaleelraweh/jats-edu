...
class SupportMenuRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        switch ($this->method()) {
            ...
            case 'PATCH': {
                    return [
                        'title.*' => 'required|unique_translation:web_menus,title,NULL,section,section,' . $this->get('section') . ',id,id' . $this->route()->support_menu,
                        'link'              =>   'nullable',
                        'icon'              =>  'nullable',
                        'parent_id'         =>   'nullable',
                        'section'           =>   'required',
