                                        ...
                                        <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="woocommerce-cart-form__cart-item cart_item">
                                                    ...
                                                    <td class="product-remove">
                                                        <a href="#" wire:click.prevent="removeFromWishlist('{{ $item->rowId }}')" class="remove" aria-label="Remove this item">
                                                            <i class="far fa-trash-alt text-secondary font-size-sm"></i>
                                                            Remove
                                                        </a> <br>
                                                        <a href="#" wire:click.prevent="moveToCart('{{ $item->rowId }}')" class="remove" aria-label="Remove this item">
                                                            <i class="fas fa-sort-amount-up text-secondary font-size-sm"></i>
                                                            Move to Cart
                                                        </a>
                                                    </td>
