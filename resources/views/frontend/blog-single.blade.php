    ...
    <div class="container">
        ...
        <div class="row align-items-end mb-4 mb-md-7">
            ...
            <div class="col-md-auto">
                <a href="course-single-v1.html" class="d-flex align-items-center fw-medium">
                    Browse All
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        <ul class="nav mx-n3 mb-3">
                            <li class="nav-item px-3">
                                <a href="course-single-v1.html" class="d-flex align-items-center text-gray-800">
                        ...
                        <!-- Heading -->
                        <a href="course-single-v1.html" class="d-block">
                            <h5 class="line-clamp-2 h-48 h-lg-52">The Best Destinations to Begin Your Round the World Trip
                            </h5>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        ...
                        <!-- Heading -->
                        <a href="course-single-v1.html" class="d-block">
                            <h5 class="line-clamp-2 h-48 h-lg-52">An Indigenous Anatolian Syllabic Script From 3500 Years
                                Ago</h5>
                        </a>
                    </div>
                </div>
