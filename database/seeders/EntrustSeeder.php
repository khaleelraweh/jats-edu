...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Sponsers
        $manageSponsers = Permission::create(['name' => 'manage_sponsers', 'display_name' => ['ar'  =>  'إدارة الجهات التعليمية',    'en'    =>  'Manage Sponsers'], 'route' => 'sponsers', 'module' => 'sponsers', 'as' => 'sponsers.index', 'icon' => 'fas fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '20',]);
        ...
        $displaySponsers   =  Permission::create(['name' => 'display_sponsers', 'display_name'    =>  ['ar'   =>  'عرض جهة تعليمية',              'en'    =>  'Display Sponser'], 'route' => 'sponsers', 'module' => 'sponsers', 'as' => 'sponsers.show', 'icon' => null, 'parent' => $manageSponsers->id, 'parent_original' => $manageSponsers->id, 'parent_show' => $manageSponsers->id, 'sidebar_link' => '0', 'appear' => '0']);
