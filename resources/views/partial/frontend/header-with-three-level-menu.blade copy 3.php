<header class="navbar navbar-expand-xl {{ request()->routeIs('frontend.service') ? 'navbar-light bg-white border-bottom py-2 py-xl-4' : 'navbar-dark' }} ">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav navbar-vertical ms-xl-4 d-none">
            <li class="nav-item dropdown">
                <a class="nav-link pb-4 mb-n4 px-0 pt-0" id="navbarVerticalMenu" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                    <div class="  {{ request()->routeIs('frontend.service') ? 'bg-primary' : 'bg-white' }} rounded py-3 px-4 d-flex align-items-center">
                        <div class="me-3 ms-1 d-flex {{ request()->routeIs('frontend.service') ? 'text-white' : 'text-primary' }}">
                            <!-- Icon -->
                        ...
                        <span class="{{ request()->routeIs('frontend.service') ? 'text-white' : 'text-primary' }} fw-medium me-1 text-uppercase">{{ __('transf.courses') }}</span>
                    </div>
                </a>


                <ul class="dropdown-menu dropdown-menu-md {{ request()->routeIs('frontend.service') ? 'bg-primary' : 'bg-white' }} rounded py-4 mt-4 " aria-labelledby="navbarVerticalMenu">

                    @foreach ($web_menus->where('section', 1) as $menu)
                    @if (count($menu->appearedChildren) == false)
                    <li class="dropdown-item dropright">
                        <a href="#">
                            <div class="me-4 d-flex {{ request()->routeIs('frontend.service') ? 'text-white' : 'text-primary' }} icon-xs" style="display: inline-block !important">
                                <!-- Icon -->
                                <i class="{{ $menu->icon }}"></i>
                            </div>
                            {{ $menu->title }}
                    ...
                    <li class="dropdown-item dropright">
                        ...
                        <div class="dropdown-menu ps-3 top-0 pe-0 py-0 shadow-none bg-transparent">
                            <div class="dropdown-menu-md {{ request()->routeIs('frontend.service') ? 'bg-primary' : 'bg-white' }} rounded dropdown-menu-inner">
        ...
        <form class="d-none d-wd-flex ms-5 w-xl-450p">
            <div class="input-group border rounded">
                ...
                <input class="form-control placeholder-white text-white bg-transparent form-control-sm border-0 ps-0" type="search" placeholder="{{ __('transf.txt_what_do_you_want_to_learn?') }}" aria-label="Search">
            </div>
        </form>
        ...
        <div class=" collapse navbar-collapse z-index-lg" id="navbarCollapse">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @if (count($menu->appearedChildren) == false)
                <li class="">
                    <a class="nav-link dropdown px-xl-4 text-uppercase" id="navbarShop" href="." aria-haspopup="true" aria-expanded="false">
                        {{ $menu->title }}
                    </a>
                </li>
                @else
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle px-xl-4 text-uppercase" id="navbarBlog" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        {{ $menu->title }}
                    </a>
                    @if ($menu->appearedChildren !== null && count($menu->appearedChildren) > 0)
                ...
                {{-- <li class="nav-item dropdown dropdown-full-width">
                    <a class="nav-link dropdown-toggle px-xl-4 text-uppercase" id="navbarLandings"
                ...
                class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v2.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v2.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v3.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v3.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v4.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v4.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v5.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v5.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v6.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v6.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v7.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v7.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v8.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v8.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v9.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v9.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v10.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v10.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v11.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v11.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v12.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v12.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v13.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v13.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v14.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v14.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
        ...
        <div class="col mb-5 col-wd-auto">
            ...
            <a class="dropdown-item" href="home-v15.html" target="_blank">
                <img src="{{ asset('frontend/assets/img/menu/home-v15.jpg') }}" class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152" alt="...">
                <!-- Heading -->
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle px-xl-4 text-uppercase" id="navbarShop" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
            Shop
        </a>
    ...
    <ul class="navbar-nav flex-row ms-auto ms-xl-0 me-n2 me-md-n4">
        ...
        <li class="nav-item border-0 px-0">
            ...
            <a href="#" class="nav-link d-flex px-3 px-md-4 position-relative text-white-all icon-xs" data-bs-toggle="modal" data-bs-target="#cartModal">
                <span class="badge badge-coral text-white rounded-circle fw-bold badge-float mt-n1 ms-n2 px-0 w-16" style="font-size: 8px;">2</span>
                <!-- Icon -->
