<header
    ...
    <div class="container-fluid">
        ...
        @php
            $course_categories = App\Models\WebMenu::tree();
        @endphp
        ...
        <ul class="navbar-nav navbar-vertical ms-xl-4 d-none">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-md {{ request()->routeIs('frontend.service') ? 'bg-primary' : 'bg-white' }} rounded py-4 mt-4 "
                    ...
                    @foreach ($course_categories->where('section', 1) as $menu)
        ...
        <div class=" collapse navbar-collapse z-index-lg" id="navbarCollapse">
            ...
            <ul class="navbar-nav ms-auto ">
                        ...
                        <div class="row row-cols-2 row-cols-md-4 row-cols-lg-5 row-cols-xl-6">
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v2.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v2.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v3.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v3.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v4.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v4.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v5.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v5.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v6.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v6.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v7.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v7.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v8.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v8.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v9.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v9.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v10.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v10.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v11.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v11.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v12.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v12.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v13.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v13.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v14.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v14.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                            ...
                            <div class="col mb-5 col-wd-auto">
                                ...
                                <a class="dropdown-item" href="home-v15.html" target="_blank">
                                    <img src="{{ asset('frontend/assets/img/menu/home-v15.jpg') }}"
                                        class="img-fluid shadow rounded border d-flex mx-auto mb-5 h-md-152"
                                        alt="...">
                                    <!-- Heading -->
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle px-xl-4 text-uppercase" id="navbarCourses"
                        data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        Courses
                    </a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle px-xl-4 text-uppercase" id="navbarPages"
                        data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        Pages
                    </a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle px-xl-4 text-uppercase" id="navbarDocumentation"
                        data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        Documentation
                    </a>
