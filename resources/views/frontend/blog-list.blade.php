            ...
            <div class="col-md-7 col-lg-8 col-xl-9 mb-5 mb-md-0">
                ...
                <div class="row mb-6 align-items-center">
                    ...
                    <div class="col-lg-6 col-xl-7">
                        ...
                        <p class="line-clamp-3 mb-6 mb-xl-8 me-xl-6">Convallis vitae, nunc ut venenatis, lectus. Tellus nunc
                ...
                <div class="row mb-6 align-items-center">
                    ...
                    <div class="col-lg-6 col-xl-7">
                        ...
                        <p class="line-clamp-3 mb-6 mb-xl-8 me-xl-6">Convallis vitae, nunc ut venenatis, lectus. Tellus
                            nunc orci dolor nec facilisis et lacus, eu aliquet. Amet imperdiet ac venenatis, lacus. Tortor
                            interdum quisque et, eu etiam ac.</p>
