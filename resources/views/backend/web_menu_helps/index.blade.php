        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header py-3 d-flex justify-content-between">
                    ...
                    <div class="ml-auto">
                        @ability('admin', 'create_web_menu_helps')
                            <a href="{{ route('admin.web_menu_helps.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    {{-- filter form part  --}}
                    @include('backend.web_menu_helps.filter.filter')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('admin.web_menu_helps.edit', $menu->id) }}"
                                            ...
                                            <form action="{{ route('admin.web_menu_helps.destroy', $menu->id) }}"
