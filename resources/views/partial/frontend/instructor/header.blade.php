<header
    class="navbar navbar-expand-xl {{ !request()->routeIs('frontend.index') ? 'navbar-light bg-white border-bottom py-1 py-xl-1' : 'navbar-dark' }} ">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav flex-row ms-auto ms-xl-0 me-n2 me-md-n4">
            ...
            <li class="nav-item border-0 px-0">
                ...
                <a href="#"
                    class="nav-link d-none d-md-flex px-3 px-md-4  {{ !request()->routeIs('frontend.index') ? 'text-secondary' : 'text-white-all' }} icon-sm"
            ...
            <li class="nav-item border-0 px-0">
                ...
                <a type="button" href="{{ route('frontend.index') }}"
                    ...
                    <span width="20" height="20" class="d-inline-block">Student</span>
                </a>
            ...
            <!-- Toggler -->
            <button href="#"
                class=" navbar-toggler ms-4 ms-md-5 shadow-none bg-teal text-white icon-xs p-0 outline-0 h-40p w-40p d-flex d-md-none place-flex-center"
                data-bs-toggle="modal" data-bs-target="#accountModal">
                <!-- Icon -->
