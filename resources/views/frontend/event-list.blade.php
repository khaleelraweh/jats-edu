...
@section('content')
    ...
    <div class="container pb-4 pb-xl-7">
            ...
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="{{ route('frontend.event_single', $post->slug) }}"
                            class="card-img d-block sk-thumbnail img-ratio-3 card-hover-overlay"><img
                                ...
                                src="{{ asset('frontend/assets/img/post/post-1.jpg') }}" alt="{{ $post->title }}"></a>
                        <a href="{{ route('frontend.event_single', $post->slug) }}"
                    ...
                    <div class="card-footer px-2 pb-2 pt-4">
                        <!-- Heading -->
                        <a href="{{ route('frontend.event_single', $post->slug) }}" class="d-block">
                            <h5 class="line-clamp-2 h-48 h-lg-52 mb-2">Discover Law - Get into the best UK law schools</h5>
                        </a>
        ...
        <div class="text-center mb-9">
            <a class="btn btn-outline-primary mw-300p d-flex mx-auto read-more" data-bs-toggle="collapse"
