                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group iconpicker-container ">
                                        ...
                                        <span class="input-group-addon btn btn-primary">
                                            <i class="{{ $webMenu->companyMenu ?? 'fas fa-archive' }}"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="col-sm-12 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[{{ $key }}]"
                                            id="title[{{ $key }}]"
                                            value="{{ old('title.' . $key, $companyMenu->title) }}" class="form-control">
                                        @error('title.' . $key)
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-sm-12 pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="link" name="link"
                                        value="{{ old('link', $companyMenu->link) }}" class="form-control">
                                    @error('link')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12  pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on" name="published_on"
                                        value="{{ old('published_on', \Carbon\Carbon::parse($companyMenu->published_on)->Format('Y-m-d')) }}"
                                        class="form-control">
                                    @error('published_on')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-12  pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on_time" name="published_on_time"
                                        value="{{ old('published_on_time', \Carbon\Carbon::parse($companyMenu->published_on)->Format('h:i A')) }}"
                                        class="form-control">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12 col-sm-12 pt-4">
                                ...
                                <select name="status" class="form-control">
                                    <option value="">---</option>
                                    <option value="1"
                                        {{ old('status', $companyMenu->status) == '1' ? 'selected' : null }}>
                                        {{ __('panel.status_active') }}
                                    </option>
                                    <option value="0"
                                        {{ old('status', $companyMenu->status) == '0' ? 'selected' : null }}>
