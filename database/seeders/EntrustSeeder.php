...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Product Reviews
        $manageProductReviews = Permission::create(['name' => 'manage_product_reviews', 'display_name' => ['ar' =>  'إدارة التعليقات',  'en'    =>  'Manage Comments'], 'route' => 'product_reviews', 'module' => 'product_reviews', 'as' => 'product_reviews.index', 'icon' => 'fas fa-comment', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '2000',]);
