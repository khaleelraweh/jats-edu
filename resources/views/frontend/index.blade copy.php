...
<section class="mt-n12">
    {{-- {{ dd($instructors) }} --}}
    <div class="flickity-page-dots-vertical flickity-page-dots-md flickity-page-dots-white position-static" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "center", "wrapAround": true, "imagesLoaded": true}'>

        @forelse ($main_sliders->where('section' ,1) as $main_slider)
        <div class="w-100">
            <div class="vh-100 bg-cover position-relative overlay overlay-custom" style="background-image: url({{ asset('assets/main_sliders/' . $main_slider->firstMedia?->file_name) }})">
                    ...
                    <div class="mx-lg-n5">
                        <div class="vh-100 row gx-0 mx-auto">
                            <div class="col-12 mt-12 mb-4 my-md-auto text-center" style="z-index:1;">
                                ...
                                <!-- Buttons -->
                                <a href="course-single-v1.html" class="btn text-white-alone btn-slide slide-white btn-wide shadow mb-4 mb-md-0 me-md-5 text-uppercase" data-aos-duration="200" data-aos="fade-up">{{ __('transf.btn_get_started') }}</a>
                                <a href="course-single-v1.html" class="btn text-white-all btn-coral btn-wide d-none d-lg-inline-block" data-aos-duration="200" data-aos="fade-up">{{ __('transf.btn_view_courses') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
{{-- CALL ACTION --}}
<section class="py-6 py-md-12 jarallax" data-jarallax data-speed=".8" style="background-image: url({{ asset('frontend/assets/img/covers/cover-5.jpg') }})">
    <div class="container text-center py-xl-9 text-capitalize" data-aos="fade-up">
        ...
        <div class="mx-auto">
            <a href="#" class="btn btn-sienna btn-x-wide lift d-inline-block text-white">{{ __('transf.btn_get_started_now') }}</a>
        </div>
    </div>
</section>
...
<section class="py-8 py-md-11 pb-xl-12 bg-white">
    <div class="container px-xl-9">
        ...
        <div class="mx-n4 flickity-viewport-visible flickity-hover-opacity" data-flickity='{"cellAlign": "left", "wrapAround": false, "imagesLoaded": true, "pageDots": true, "prevNextButtons": false, "contain": true}'>
                        ...
                        <div class="row gx-0 align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="avatar avatar-custom">
                                    <img src="{{ asset('frontend/assets/img/avatars/avatar-2.jpg') }}" alt="..." class="avatar-img rounded-circle img-fluid">
                                </div>
                            </div>
                    ...
                    <div class="card-footer px-0 pb-0 pt-5">
                        <div class="row gx-0 align-items-center">
                            <div class="col-auto">
                                <!-- Image -->
                                <div class="avatar avatar-custom">
                                    <img src="{{ asset('frontend/assets/img/avatars/avatar-1.jpg') }}" alt="..." class="avatar-img rounded-circle img-fluid">
                                </div>
                            </div>
                    ...
                    <div class="card-footer px-0 pb-0 pt-5">
                        <div class="row gx-0 align-items-center">
                            <div class="col-auto">
                                <!-- Image -->
                                <div class="avatar avatar-custom">
                                    <img src="{{ asset('frontend/assets/img/avatars/avatar-3.jpg') }}" alt="..." class="avatar-img rounded-circle img-fluid">
                                </div>
                            </div>
                    ...
                    <div class="card-footer px-0 pb-0 pt-5">
                        <div class="row gx-0 align-items-center">
                            <div class="col-auto">
                                <!-- Image -->
                                <div class="avatar avatar-custom">
                                    <img src="{{ asset('frontend/assets/img/avatars/avatar-4.jpg') }}" alt="..." class="avatar-img rounded-circle img-fluid">
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-xl-6 mb-5 mb-md-6">
                ...
                <div class="card border shadow p-2 lift">
                    <div class="row gx-0">
                        <!-- Image -->
                        <a href="event-single.html" class="col-auto d-flex rounded-lg w-md-152 bg-bossanova place-center h-md-140p" style="width: 120px;">
        ...
        <div class="row row-cols-md-2 row-cols-lg-3">
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="blog-single.html" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="{{ asset('frontend/assets/img/post/post-1.jpg') }}" alt="..."></a>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="blog-single.html" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="{{ asset('frontend/assets/img/post/post-2.jpg') }}" alt="..."></a>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="blog-single.html" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="{{ asset('frontend/assets/img/post/post-3.jpg') }}" alt="..."></a>
...
<section class="py-5 py-md-11 bg-catskill">
    <div class="container">
        ...
        <div class="mx-n3 mx-md-n4" data-flickity='{"pageDots": false,"cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
            ...
            <div class="col-6 col-md-4 col-lg-3 text-center py-5 text-md-left px-3 px-md-4" data-aos="fade-up" data-aos-delay="{{ 50 * $loop->iteration }}">
                <div class="card border shadow p-2 lift">
                    <!-- Image -->
                    <div class="card-zoom position-relative" style="max-width: 250px;">
                        ...
                        <a href="instructors-single.html" class="card-img sk-thumbnail img-ratio-4 card-hover-overlay coral d-block">
                            @php
                            if ($instructor->user_image != null) {
                            $instructor_img = asset('assets/instructors/' . $instructor->user_image);

                            if (
                            !file_exists(public_path('assets/instructors/' . $instructor->user_image))
                            ) {
                            ...
                            @endphp
                            <img class="rounded shadow-light-lg img-fluid" src="{{ $instructor_img }}" alt="{{ $instructor->full_name }}">
                        </a>
                    </div>
...
{{-- COUNTUP --}}
<section class="py-5 py-md-12 jarallax" data-jarallax data-speed=".8" style="background-image: url({{ asset('frontend/assets/img/covers/cover-6.jpg') }})">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-7">
                ...
                <p class="text-coral text-capitalize font-size-lg mb-5">
                    {{ __('transf.txt_get_100_online_courses_for_free') }}
                </p>
                <div class="row text-center mx-md-n1 mx-lg-n5">
                    <div class="col-md-auto px-md-1 px-lg-5 mb-6 mb-md-0">
                        <div class="mb-4 mx-auto border-white border-w-md border rounded-circle h-90p w-90p d-flex align-items-center justify-content-center flex-column">
                            <div class="h2 text-white mb-0"><span data-toggle="countup" data-from="0" data-to="40" data-aos data-aos-id="countup:in"></span></div>
                        </div>
                    ...
                    <div class="col-md-auto px-md-1 px-lg-5 mb-6 mb-md-0">
                        <div class="mb-4 mx-auto border-white border-w-md border rounded-circle h-90p w-90p d-flex align-items-center justify-content-center flex-column">
                            <div class="h2 text-white mb-0"><span data-toggle="countup" data-from="0" data-to="59" data-aos data-aos-id="countup:in"></span></div>
                        </div>
                    ...
                    <div class="col-md-auto px-md-1 px-lg-5 mb-6 mb-md-0">
                        <div class="mb-4 mx-auto border-white border-w-md border rounded-circle h-90p w-90p d-flex align-items-center justify-content-center flex-column">
                            <div class="h2 text-white mb-0"><span data-toggle="countup" data-from="0" data-to="27" data-aos data-aos-id="countup:in"></span></div>
                        </div>
                    ...
                    <div class="col-md-auto px-md-1 px-lg-5 mb-6 mb-md-0">
                        <div class="mb-4 mx-auto border-white border-w-md border rounded-circle h-90p w-90p d-flex align-items-center justify-content-center flex-column">
                            <div class="h2 text-white mb-0"><span data-toggle="countup" data-from="0" data-to="10" data-aos data-aos-id="countup:in"></span></div>
                        </div>
            ...
            <div class="col-md-5">
                <div class="text-center">
                    <p class="text-coral text-capitalize font-size-lg mb-2">
                        {{ __('transf.txt_create_free_account_to_get') }}
                    </p>
                    <h3 class="text-uppercase text-white mb-6">
                        {{ __('transf.txt_the_complete_web_developer_course') }}
                    </h3>
                </div>
                ...
                <div class="bg-white p-5 p-lg-7 rounded-lg">
                    <form class="mb-2">
                        <div class="form-group mb-6">
                            <input type="text" class="form-control form-control-sm placeholder-1" id="cardName" placeholder="{{ __('transf.holder_your_name') }}">
                            <label class="sr-only" for="cardName">Name</label>
                        </div>
                        <div class="form-group mb-6">
                            <input type="email" class="form-control form-control-sm placeholder-1" id="cardEmail" placeholder="{{ __('transf.holder_email') }}">
                            <label class="sr-only" for="cardEmail">Email</label>
                        </div>
                        <div class="form-group mb-6">
                            <input type="number" class="form-control form-control-sm placeholder-1" id="cardPhone" placeholder="{{ __('transf.holder_phone') }}">
        ...
        <div class="row align-items-center py-2">
            <div class="col-xl-6 mb-4 mb-xl-0">
                ...
                <p class="font-size-lg text-white mb-0 text-capitalize">
                    {{ __('transf.txt_subscrive_our_newsletter_desc') }}
                </p>
            </div>
            ...
            <div class="col-xl-6">
                <form class="ms-xl-5">
                    <div class="input-group d-block d-md-flex bg-white p-1 rounded">
                        <input type="text" class="form-control w-100 w-md-auto form-control-sm rounded border-0 placeholder-1" placeholder="{{ __('transf.holder_enter_your_email') }}" aria-label="Enter your email" aria-describedby="button-addon2">
                        <div class="input-group-append ms-0">
                            <button class="btn btn-sm btn-bossanova w-100 w-md-auto btn-wide rounded border-0" type="button" id="button-addon2">{{ __('transf.btn_subscribe') }}</button>
                        </div>
                    </div>
                </form>
            </div>
