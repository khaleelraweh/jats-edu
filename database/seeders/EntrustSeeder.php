...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $displaySponsors   =  Permission::create(['name' => 'display_sponsors', 'display_name'    =>  ['ar'   =>  'عرض جهة تعليمية',              'en'    =>  'Display Sponser'], 'route' => 'sponsors', 'module' => 'sponsors', 'as' => 'sponsors.show', 'icon' => null, 'parent' => $manageSponsors->id, 'parent_original' => $manageSponsors->id, 'parent_show' => $manageSponsors->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateSponsors    =  Permission::create(['name' => 'update_sponsors', 'display_name'     =>  ['ar'   =>  'تعديل جهة تعليمية',            'en'    =>  'Edit Sponser'], 'route' => 'sponsors', 'module' => 'sponsors', 'as' => 'sponsors.edit', 'icon' => null, 'parent' => $manageSponsors->id, 'parent_original' => $manageSponsors->id, 'parent_show' => $manageSponsors->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteSponsors    =  Permission::create(['name'  => 'delete_sponsors', 'display_name'     =>  ['ar'   =>  'حذف جهة تعليمية',              'en'    =>  'Delete Sponser'], 'route' => 'sponsors', 'module' => 'sponsors', 'as' => 'sponsors.destroy', 'icon' => null, 'parent' => $manageSponsors->id, 'parent_original' => $manageSponsors->id, 'parent_show' => $manageSponsors->id, 'sidebar_link' => '0', 'appear' => '0']);
