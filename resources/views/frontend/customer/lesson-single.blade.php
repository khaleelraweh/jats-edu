    ...
    <header class="bg-portgore py-3">
        <div class="px-5 px-lg-8 w-100">
            <div class="d-md-flex align-items-center">
                ...
                <!-- Back to Course -->
                <a href="course-single-v1.html" class="btn btn-sm btn-orange ms-md-6 px-6 mb-3 mb-md-0 flex-shrink-0">Back
                    to Course</a>
            </div>
        </div>
    </header>
                ...
                <div class="bg-portgore rounded p-6">
                    ...
                    <div id="accordionCurriculum" class="">
                            ...
                            <div id="CurriculumcollapseOne" class="collapse show" aria-labelledby="curriculumheadingOne"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="badge btn-orange-soft text-white-70 me-5 font-size-sm fw-normal py-2">
                                            30 min</div>
                            ...
                            <div id="CurriculumcollapseTwo" class="collapse show" aria-labelledby="curriculumheadingTwo"
                                ...
                                <div
                                    ...
                                    <div
                                        class="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                        <button
                                            class="btn btn-sm btn-orange-soft text-white-70 me-5 font-size-sm fw-normal py-1">30
                                            min</button>
                                        <a href="#" class="text-secondary">
                                            <!-- Icon -->
                                            <svg width="14" height="16" viewBox="0 0 14 16"
                        ...
                        <div class="overflow-hidden bg-dark rounded mb-6">
                            <div class="d-flex align-items-center" id="curriculumheadingThree">
                                <h5 class="mb-0 w-100">
                                    <button
                                        ...
                                        data-bs-target="#CurriculumcollapseThree" aria-expanded="true"
                            ...
                            <div id="CurriculumcollapseThree" class="collapse show"
                        ...
                        <div class="overflow-hidden bg-dark rounded mb-6">
                            <div class="d-flex align-items-center" id="curriculumheadingFour">
                                <h5 class="mb-0 w-100">
                                    <button
                                        ...
                                        aria-expanded="true" aria-controls="CurriculumcollapseFour">
                                        <span class="me-4 text-white d-flex">
                                            <!-- Icon -->
                                            <svg width="15" height="2" viewBox="0 0 15 2" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div id="CurriculumcollapseFour" class="collapse show"
