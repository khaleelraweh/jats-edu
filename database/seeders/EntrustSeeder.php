...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Partners
        $managePartners = Permission::create(['name' => 'manage_partners', 'display_name' => ['ar'  =>  'شركائنا',    'en'    =>  'Our Partners'], 'route' => 'partners', 'module' => 'partners', 'as' => 'partners.index', 'icon' => 'fas fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '50',]);
        ...
        // CompanyRequests
        $manageCompanyRequests = Permission::create(['name' => 'manage_company_requests', 'display_name' => ['ar'  =>  'إدارة طلبات الشركات',    'en'    =>  'Manage Company Request'], 'route' => 'company_requests', 'module' => 'company_requests', 'as' => 'company_requests.index', 'icon' => 'fas fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '55',]);
