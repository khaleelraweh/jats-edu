...
@section('content')
    ...
    <header class="py-8 py-md-11" style="background-image: none;">
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">About Us v1</h1>
    ...
    <!-- TESTIMONIAL -->
    <section class="py-8 pt-xl-11 pb-xl-9 bg-white">
    ...
    <!-- CALL ACTION -->
    <section class="py-6 py-md-11 border-top" data-jarallax data-speed=".8"
