                                ...
                                <div class="{{ $loop->index == 0 ? 'col-md-7' : '' }} col-sm-12 ">
                                                ...
                                                <select name="course_category_id" class="form-control">
                                                    ...
                                                    @forelse ($course_categories as $course_category)
                                                        <option value="{{ $course_category->id }}"
                                                            {{ old('course_category_id', $event->course_category_id) == $course_category->id ? 'selected' : null }}>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 pt-4">
                                            ...
                                            {!! old('description.' . $key, $event->getTranslation('description', $key)) !!}
                                        </textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <select name="skill_level" class="form-control">
                                    <option value="1"
                                        {{ old('skill_level', $event->skill_level) == '1' ? 'selected' : null }}>
                                        {{ __('panel.skill_level_beginner') }}
                                    </option>
                                    <option value="2"
                                        {{ old('skill_level', $event->skill_level) == '2' ? 'selected' : null }}>
                                        {{ __('panel.skill_level_intermediate') }}
                                    </option>
                                    <option value="3"
                                        {{ old('skill_level', $event->skill_level) == '3' ? 'selected' : null }}>
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <select name="language" class="form-control">
                                    <option value="1"
                                        {{ old('language', $event->language) == '1' ? 'selected' : null }}>
                                        {{ __('panel.language_ar') }}
                                    </option>
                                    <option value="2"
                                        {{ old('language', $event->language) == '2' ? 'selected' : null }}>
                        ...
                        <div class="row d-none">
                            <div class="col-sm-12 pt-3">
                                ...
                                <select name="evaluation" class="form-control">
                                    <option value="1"
                                        {{ old('evaluation', $event->evaluation) == '1' ? 'selected' : null }}>
                                        {{ __('panel.evaluation_normal') }}
                                    </option>
                                    <option value="2"
                                        {{ old('evaluation', $event->evaluation) == '2' ? 'selected' : null }}>
                                        {{ __('panel.evaluation_featured') }}
                                    </option>
                                    <option value="3"
                                        {{ old('evaluation', $event->evaluation) == '3' ? 'selected' : null }}>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <input type="number" name="lecture_numbers" id="lecture_numbers"
                                    value="{{ old('lecture_numbers', $event->lecture_numbers) }}" class="form-control">
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <input type="text" name="course_duration" id="course_duration"
                                    value="{{ old('course_duration', $event->course_duration) }}" class="form-control"
                                    placeholder="8h 17m">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <input type="text" name="video_promo" id="video_promo"
                                    value="{{ old('video_promo', $event->video_promo) }}" class="form-control">
                                @error('video_promo')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <input type="text" name="video_description" id="video_description"
                                    value="{{ old('video_description', $event->video_description) }}"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <select name="course_type" class="form-control">
                                    <option value="1"
                                        {{ old('course_type', $event->course_type) == '1' ? 'selected' : null }}>
                                        {{ __('panel.course_type_presence') }}
                                    </option>
                                    <option value="2"
                                        {{ old('course_type', $event->course_type) == '2' ? 'selected' : null }}>
                        ...
                        <div class="row deadline">
                            <div class="col-sm-12 col-md-6 pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="deadline" name="deadline"
                                        value="{{ old('deadline', \Carbon\Carbon::parse($event->deadline)->Format('Y-m-d')) }}"
                                        class="form-control">
                                    @error('deadline')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                ...
                                <select name="certificate" class="form-control">
                                    <option value="1"
                                        {{ old('certificate', $event->certificate) == '1' ? 'selected' : null }}>
                                        {{ __('panel.certificate_yes') }}
                                    </option>
                                    <option value="2"
                                        {{ old('certificate', $event->certificate) == '0' ? 'selected' : null }}>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 pt-3">
                                ...
                                <input type="text" name="price" id="price"
                                    value="{{ old('price', $event->price) }}" class="form-control">
                                @error('price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 pt-3">
                                ...
                                <input type="text" id="offer_price" name="offer_price"
                                    value="{{ old('offer_price', $event->offer_price) }}" class="form-control">
                                @error('offer_price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-12 col-md-12 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on" name="published_on"
                                        value="{{ old('published_on', \Carbon\Carbon::parse($event->published_on)->Format('Y-m-d')) }}"
                                        class="form-control">
                                    @error('published_on')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-12 col-md-12 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on_time" name="published_on_time"
                                        value="{{ old('published_on_time', \Carbon\Carbon::parse($event->published_on)->Format('h:i A')) }}"
                                        class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 pt-3">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1"
                                        {{ old('status', $event->status) == '1' ? 'selected' : null }}>
                                        {{ __('panel.status_active') }}
                                    </option>
                                    <option value="0"
                                        {{ old('status', $event->status) == '0' ? 'selected' : null }}>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 pt-4">
                                ...
                                <select name="featured" class="form-control">
                                    <option value="1"
                                        {{ old('featured', $event->featured) == '1' ? 'selected' : null }}>
                                        {{ __('panel.yes') }}
                                    </option>
                                    <option value="0"
                                        {{ old('featured', $event->featured) == '0' ? 'selected' : null }}>
                                        {{ __('panel.no') }}
                                    </option>
                                </select>
                                @error('featured')
