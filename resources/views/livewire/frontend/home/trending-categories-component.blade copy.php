        ...
        <div class="container">
            ...
            <div class="row row-cols-md-3 row-cols-xl-4 mb-4">
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html" class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p" style="background-image: url({{ $course_category_img }})">
                        <div class="my-auto">
                            <!-- Image -->
            ...
            <div class="text-center">
                ...
                <a href="#" class="btn btn-outline-sienna btn-x-wide lift d-inline-block">{{ __('transf.btn_view_all_courses') }}
                </a>
                @else
