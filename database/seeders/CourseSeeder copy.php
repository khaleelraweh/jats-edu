...
class CourseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $courses1['course_category_id']     =   $categories->random();
        ...
        $courses2['course_category_id']     =   $categories->random();
        ...
        $courses3['course_category_id']     =   $categories->random();
        ...
        $courses4['course_category_id']     =   $categories->random();
