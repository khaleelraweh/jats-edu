                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 pt-4">
                                        ...
                                        <textarea name="description[{{ $key }}]" rows="10" class="form-control" id="tinymceExample">
                                            {!! old('description.' . $key, $advertisorSlider->getTranslation('description', $key)) !!}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="btn_one_name[{{ $key }}]"
                                            id="btn_one_name[{{ $key }}]"
                                            value="{{ old('btn_one_name.' . $key, $advertisorSlider->getTranslation('btn_one_name', $key)) }}"
                                            class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 pt-4">
                                ...
                                <input type="text" name="btn_one_url" id="btn_one_url"
                                    value="{{ old('btn_one_url', $advertisorSlider->btn_one_url ?? '') }}"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 pt-4">
                                ...
                                <select name="btn_one_target" class="form-control">
                                    <option value="_self"
                                        {{ old('btn_one_target', $advertisorSlider->btn_one_target ?? '_self') == '_self' ? 'selected' : null }}>
                                        {{ __('panel.in_the_same_tab') }}
                                    </option>
                                    <option value="_blank"
                                        {{ old('btn_one_target', $advertisorSlider->btn_one_target ?? '_self') == '_blank' ? 'selected' : null }}>
                                        {{ __('panel.in_new_tab') }}
                                    </option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 pt-4">
                                ...
                                <select name="btn_one_show" class="form-control">
                                    <option value="1"
                                        {{ old('btn_one_show', $advertisorSlider->btn_one_show ?? 1) == 1 ? 'selected' : null }}>
                                        {{ __('panel.show') }}
                                    </option>
                                    <option value="0"
                                        {{ old('btn_one_show', $advertisorSlider->btn_one_show ?? 1) == 0 ? 'selected' : null }}>
                                        {{ __('panel.hide') }}
                                    </option>
                                </select>
                                @error('btn_one_show')
