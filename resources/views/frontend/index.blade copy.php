        ...
        <div class="flickity-page-dots-vertical flickity-page-dots-md flickity-page-dots-white position-static"
            ...
            <div class="w-100">
                <div class="vh-100 bg-cover position-relative overlay overlay-custom"
                    style="background-image: url({{ asset('frontend/assets/img/covers/cover-4.jpg') }})">
                            ...
                            <div class="vh-100 row gx-0 mx-auto">
                                <div class="col-12 mt-12 mb-4 my-md-auto text-center" style="z-index:1;">
                                    ...
                                    <a href="course-single-v1.html"
                                        ...
                                        data-aos-duration="200" data-aos="fade-up">{{ __('transf.btn_get_started') }}</a>
                                    <a href="course-single-v1.html"
                                        class="btn text-white-all btn-coral btn-wide d-none d-lg-inline-block"
                                        data-aos-duration="200" data-aos="fade-up">{{ __('transf.btn_view_courses') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-100">
                <div class="vh-100 bg-cover position-relative overlay overlay-custom"
                    style="background-image: url({{ asset('frontend/assets/img/covers/cover-21.jpg') }})">
                    <div class="container position-static pt-9 pt-md-12 pb-8 py-lg-0">
                        <div class="mx-lg-n5">
                            <div class="vh-100 row gx-0 mx-auto">
                                <div class="col-12 mt-12 mb-4 my-md-auto text-center" style="z-index:1;">
                ...
                <ul class="nav row justify-content-between">
                    ...
                    <li class="col-lg-auto mb-5 mb-lg-0 nav-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="media-body">
                                <h4 class="text-white mb-0 text-uppercase">{{ __('transf.txt_expert_instruction') }}</h4>
    ...
    <section class="py-5 py-md-11">
        <div class="container">
            ...
            <div class="row row-cols-md-3 row-cols-xl-4 mb-4">
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        ...
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-3.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            ...
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Design</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 960 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-4.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Business</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 43 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-5.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Software Development</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 1209 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-6.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Personal Development</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 921 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-7.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Photography</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 693 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-8.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Audio + Music</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 53 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-9.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Marketing</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 12 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md mb-6">
                    ...
                    <a href="course-list-v4.html"
                        class="card card-hover-image px-md-5 py-md-5 px-4 py-8 text-center position-relative h-180p"
                        style="background-image: url({{ asset('frontend/assets/img/photos/photo-10.jpg') }})">
                        <div class="my-auto">
                            <!-- Image -->
                            <div class="text-white hover-image display-4">
                            ...
                            <!-- Footer -->
                            <div class="card-footer p-0">
                                <h5 class="mb-0 line-clamp-1 text-white">Finance & Accounting</h5>
                                <p class="mb-0 line-clamp-1 text-white">Over 322 Courses</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="text-center">
                <a href="#"
                    class="btn btn-outline-sienna btn-x-wide lift d-inline-block">{{ __('transf.btn_view_all_courses') }}</a>
            </div>
        </div>
    </section>
    ...
    <section class="pt-5 pb-9 py-md-11 bg-white">
        <div class="container">
            <div class="text-center mb-5 mb-md-8">
                <h1 class="mb-1">{{ __('transf.txt_featured_courses') }}</h1>
                ...
                <div class="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                    ...
                    <div class="card border shadow p-2 sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <a href="course-single-v2.html" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg"
                                    src="{{ asset('frontend/assets/img/products/product-8.jpg') }}" alt="...">
                            </a>
                        </div>

                        <!-- Footer -->
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            <a href="course-single-v2.html" class="">
                                <div
                                    class="avatar avatar-xl badge-float position-absolute top-0 right-0 mt-n6 me-5 rounded-circle shadow border border-white border-w-lg">
                ...
                <div class="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" style="padding-right:15px;padding-left:15px;">
                    ...
                    <div class="card border shadow p-2 sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <a href="course-single-v2.html" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg"
                                    src="{{ asset('frontend/assets/img/products/product-9.jpg') }}" alt="...">
                            </a>
                        ...
                        <form class="mb-2">
                            <div class="form-group mb-6">
                                <input type="text" class="form-control form-control-sm placeholder-1"
                                    id="cardName" placeholder="{{ __('transf.holder_your_name') }}">
                                <label class="sr-only" for="cardName">Name</label>
                            </div>
                            <div class="form-group mb-6">
                                <input type="email" class="form-control form-control-sm placeholder-1"
                                    id="cardEmail" placeholder="{{ __('transf.holder_email') }}">
                                <label class="sr-only" for="cardEmail">Email</label>
                            </div>
                            <div class="form-group mb-6">
                                <input type="number" class="form-control form-control-sm placeholder-1"
                                    id="cardPhone" placeholder="{{ __('transf.holder_phone') }}">
