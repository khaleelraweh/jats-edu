...
@section('content')
    <div class="card shadow mb-4">
        ...
        @include('backend.course_reviews.filter.filter')
                ...
                <tbody>
                    @forelse ($reviews as $review)
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">{{ $review->course->title }}</td>
                            <td>{{ $review->status() }}</td>
                            <td class="d-none d-sm-table-cell">{{ $review->created_at }}</td>
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('admin.course_reviews.edit', $review->id) }}" class="btn btn-primary">
                                ...
                                <form action="{{ route('admin.course_reviews.destroy', $review->id) }}" method="post"
