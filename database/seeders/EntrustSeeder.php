...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // certificate_issues
        $manageCertificateIssues = Permission::create(['name' => 'manage_certificate_issues', 'display_name' => ['ar'  =>  'إدارة الشهائد',    'en'    =>  'Manage Certificates'], 'route' => 'certificate_issues', 'module' => 'certificate_issues', 'as' => 'certificate_issues.index', 'icon' => 'fas fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '20',]);
        $manageCertificateIssues->parent_show = $manageCertificateIssues->id;
        $manageCertificateIssues->save();
        $showCertificateIssues      =  Permission::create(['name'  => 'show_certificate_issues', 'display_name'       =>  ['ar'   =>  'الشهائد',               'en'    =>  'Certificates'], 'route' => 'certificate_issues', 'module' => 'certificate_issues', 'as' => 'certificate_issues.index', 'icon' => 'fas fas fa-newspaper', 'parent' => $manageCertificateIssues->id, 'parent_original' => $manageCertificateIssues->id, 'parent_show' => $manageCertificateIssues->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createCertificateIssues    =  Permission::create(['name'  => 'create_certificate_issues', 'display_name'     =>  ['ar'   =>  'إنشاء شهادة',           'en'    =>  'Create new Certificate'], 'route' => 'certificate_issues', 'module' => 'certificate_issues', 'as' => 'certificate_issues.create', 'icon' => null, 'parent' => $manageCertificateIssues->id, 'parent_original' => $manageCertificateIssues->id, 'parent_show' => $manageCertificateIssues->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displayCertificateIssues   =  Permission::create(['name' => 'display_certificate_issues', 'display_name'    =>  ['ar'   =>  'عرض شهادة',              'en'    =>  'Display Certificate'], 'route' => 'certificate_issues', 'module' => 'certificate_issues', 'as' => 'certificate_issues.show', 'icon' => null, 'parent' => $manageCertificateIssues->id, 'parent_original' => $manageCertificateIssues->id, 'parent_show' => $manageCertificateIssues->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateCertificateIssues    =  Permission::create(['name' => 'update_certificate_issues', 'display_name'     =>  ['ar'   =>  'تعديل شهادة',            'en'    =>  'Edit Certificate'], 'route' => 'certificate_issues', 'module' => 'certificate_issues', 'as' => 'certificate_issues.edit', 'icon' => null, 'parent' => $manageCertificateIssues->id, 'parent_original' => $manageCertificateIssues->id, 'parent_show' => $manageCertificateIssues->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteCertificateIssues    =  Permission::create(['name'  => 'delete_certificate_issues', 'display_name'     =>  ['ar'   =>  'حذف شهادة',              'en'    =>  'Delete Certificate'], 'route' => 'certificate_issues', 'module' => 'certificate_issues', 'as' => 'certificate_issues.destroy', 'icon' => null, 'parent' => $manageCertificateIssues->id, 'parent_original' => $manageCertificateIssues->id, 'parent_show' => $manageCertificateIssues->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        // Partners
        $managePartners = Permission::create(['name' => 'manage_partners', 'display_name' => ['ar'  =>  'شركائنا',    'en'    =>  'Our Partners'], 'route' => 'partners', 'module' => 'partners', 'as' => 'partners.index', 'icon' => 'fas fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '60',]);
        $managePartners->parent_show = $managePartners->id;
        $managePartners->save();
        $showPartners   =  Permission::create(['name'  => 'show_partners', 'display_name'       =>  ['ar'   =>  'شركائنا',   'en'    =>  'Our Partners'], 'route' => 'partners', 'module' => 'partners', 'as' => 'partners.index', 'icon' => 'fas fas fa-newspaper', 'parent' => $managePartners->id, 'parent_original' => $managePartners->id, 'parent_show' => $managePartners->id, 'sidebar_link' => '1', 'appear' => '1']);
        ...
        //company menu
        $manageCompanyMenu = Permission::create(['name' => 'manage_company_menus', 'display_name' => ['ar'    =>  'إدارة قائمة الموسسة', 'en'   =>  'Company Menu'], 'route' => 'company_menus', 'module' => 'company_menus', 'as' => 'company_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '90',]);
        ...
        //Manage call_actions 
        $manageCallActions = Permission::create(['name' => 'manage_call_actions', 'display_name' => ['ar'    =>  'إجراءات الاتصال', 'en'    =>  'Call Actions'], 'route' => 'call_actions', 'module' => 'call_actions', 'as' => 'call_actions.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '120',]);
