...
class WebMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $main = WebMenu::create(['title'  => ['ar' => 'الرئيسية', 'en' => 'Main'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => null]);
        ...
        $design  = WebMenu::create(['title'  => ['ar' => 'التصميم', 'en' => 'Design'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $courses->id]);
        ...
        $web_developer = WebMenu::create(['title'  => ['ar' => 'البرمجة', 'en' => 'Development'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $courses->id]);
        ...
        WebMenu::create(['title'  => ['ar' => 'من نحن', 'en' => 'About Us'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $pages->id]);
        WebMenu::create(['title'  => ['ar' => 'تواصل معنا', 'en' => 'Contact Us'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $pages->id]);
    }
}
