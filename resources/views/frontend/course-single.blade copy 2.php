    ...
    <div class="row mb-8">
        <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
            ...
            <div class="d-md-flex align-items-center mb-5 course-single-white">
                <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6 bg-white">
                    <div class="p-2">
                        ...
                        @endphp
                        <img src="{{ $instructor_img }}" alt="..." class="rounded-circle" width="68" height="68">
                    </div>
                </div>
                ...
                <div class="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                    ...
                    <a href="{{ route('frontend.courses', $course->courseCategory->slug) }}" class="font-size-sm text-white">{{ $course->courseCategory->title }}</a>
                </div>
            ...
            <ul id="pills-tab" class="nav course-tab-v1 border-bottom h4 my-8 pt-1" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-overview-tab" data-bs-toggle="pill" href="#pills-overview" role="tab" aria-controls="pills-overview" aria-selected="true">{{ __('transf.overview') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-curriculum-tab" data-bs-toggle="pill" href="#pills-curriculum" role="tab" aria-controls="pills-curriculum" aria-selected="false">{{ __('transf.curriculum') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-instructor-tab" data-bs-toggle="pill" href="#pills-instructor" role="tab" aria-controls="pills-instructor" aria-selected="false">{{ __('transf.instructor') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-reviews-tab" data-bs-toggle="pill" href="#pills-reviews" role="tab" aria-controls="pills-reviews" aria-selected="false">{{ __('transf.reviews') }}</a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab">
                    ...
                    <div class="d-block rounded mb-8">
                        <iframe name="fancybox-frame1715613880222" class=" w-100 h-300p " allowfullscreen="allowfullscreen" allow="autoplay; fullscreen" src="{{ $course->video_description }}=1&amp;autohide=1&amp;fs=1&amp;rel=0&amp;hd=1&amp;wmode=transparent&amp;enablejsapi=1&amp;html5=1&amp;si=Amfzfmcicimk7U_V" scrolling="no"></iframe>
                    </div>
                    @endif
                    ...
                    <div id="accordionCurriculum">
                        ...
                        <div class="border rounded shadow mb-6 overflow-hidden">
                            ...
                            <div class="d-flex align-items-center" id="curriculumheading{{ $index }}">
                                <h5 class="mb-0 w-100">
                                    <button class="d-flex align-items-center p-5 min-height-80 text-dark fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#Curriculumcollapse{{ $index }}" aria-expanded="{{ $index == 0 || $index == 1 ? 'true' : 'false' }}" aria-controls="Curriculumcollapse{{ $index }}">
                            ...
                            <div id="Curriculumcollapse{{ $index }}" class="collapse {{ $index == 0 || $index == 1 ? 'show' : '' }}" aria-labelledby="curriculumheading{{ $index }}" data-parent="#accordionCurriculum">
                    ...
                    <div class="d-flex align-items-center mb-6">
                        <div class="d-inline-block rounded-circle border me-6 p-2">
                            <div class="avatar avatar-size-120">
                                ...
                                @endphp
                                <img src="{{ $instructor_img }}" alt="..." class="avatar-img rounded-circle">
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="d-block d-block rounded border p-2 shadow mb-6 bg-white">
                ...
                <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                    ...
                    @if ($course->price == 0)
                    <button class="btn btn-orange btn-block mb-6" type="button" name="button">{{ __('transf.btn_enroll') }}</button>
                    @else
                    ...
                    <a href="{{ route('frontend.shop_checkout') }}" class=" btn btn-teal btn-block text-white mb-3">{{ __('transf.btn_buy_now') }}</a>
                    @else
                    {{-- Add to cart --}}
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center py-4">
                            <a href="{{ $whatsappShareUrl }}" target="_blank" rel="noopener noreferrer" class="mx-auto text-teal fw-medium d-flex align-items-center mt-2">
                                <!-- Icon -->
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="border rounded px-6 px-lg-5 px-xl-6 pt-5 shadow">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="media mb-6 d-flex">
                            <a href="{{ route('frontend.course_single', $latest_course->slug) }}" class="w-100p d-block me-5">
                                ...
                                <img src="{{ $latest_course_img }}" alt="{{ $latest_course->title }}" class="avatar-img rounded-lg h-90p w-100p">
                            ...
                            <div class="media-body flex-grow-1">
                                <a href="{{ route('frontend.course_single', $latest_course->slug) }}" class="d-block">
                                    <h6 class="line-clamp-2 mb-3">{{ $latest_course->title }}</h6>
                                </a>


                                @if ($latest_course->offer_price > 0)
                                <del class="font-size-sm me-2">{{ currency_converter($latest_course->price) }}</del>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
            ...
            <div class="card border shadow-dark-hover p-2 sk-fade">
                ...
                <div class="card-zoom position-relative">
                    <a href="{{ route('frontend.course_single', $related_course->slug) }}" class="card-img sk-thumbnail img-ratio-3 d-block">
                ...
                <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                    <!-- Preheading -->
                    <a href="{{ route('frontend.course_single', $related_course->slug) }}"><span class="mb-1 d-inline-block text-gray-800">{{ $related_course->courseCategory->title }}</span></a>

                    <!-- Heading -->
                    <div class="position-relative">
                        <a href="{{ route('frontend.course_single', $related_course->slug) }}" class="d-block stretched-link">
                        ...
                        <div class="row mx-n2 align-items-end">
                            ...
                            <div class="col-auto px-2 text-right">
                                <div class="star-rating mb-2 mb-lg-0">
                                    <div class="rating" style="width:{{ scaleToPercentage($related_course->reviews->pluck('rating')->avg(), 5) }}%;">
                                    </div>
                                </div>
                            </div>
                        </div>
