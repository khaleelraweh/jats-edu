        ...
        <div class="container">
            ...
            <div class="row mb-8 w-xl-80 mx-xl-auto">
                <div class="col-md mb-4 mb-md-0 d-lg-flex align-items-center">
                    ...
                    <div class="row">
                        <div wire:ignore class="col-md-auto mb-4 mb-lg-0">
                            <select wire:model="categoryInputs" {{-- class="form-select form-select-sm ps-5 text-primary shadow fw-medium" data-choices> --}} class="form-select form-select-sm ps-5 text-primary shadow fw-medium" data-choices>
                        ...
                        <div wire:ignore class="col-md-auto mb-4 mb-lg-0">
                            <select wire:model="courseLevels" class="form-select form-select-sm ps-5 text-primary shadow fw-medium" data-choices>
                        ...
                        <div wire:ignore class="col-md-auto mb-4 mb-lg-0">
                            <select wire:model="priceInput" class="form-select form-select-sm ps-5 text-primary shadow fw-medium" data-choices>
                ...
                <div wire:ignore class="col-md-auto d-lg-flex align-items-center">
                    ...
                    <select wire:model="sortingBy" class="form-select form-select-sm ps-5 text-primary shadow fw-medium" data-choices>
                    ...
                    <div class="card border shadow p-2 sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <div class="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                <a href="{{ route('frontend.course_single', $featured_course->slug) }}" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                                ...
                                <a href="{{ route('frontend.course_single', $featured_course->slug) }}" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                            ...
                            <a href="{{ route('frontend.course_single', $featured_course->slug) }}" class="card-img sk-thumbnail d-block">
                                {{-- this is the image part  --}}
                                <img class="rounded shadow-light-lg" src="{{ $featured_course_img }}" alt="...">
                            </a>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            <a href="#" class="d-block">
                                <div class="avatar avatar-xl badge-float position-absolute top-0 right-0 mt-n6 me-5 rounded-circle shadow border border-white border-w-lg">
                                    <img src="{{ $featured_course_avator }}" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>

                            <!-- Preheading -->
                            <a href="{{ route('frontend.courses', $featured_course->courseCategory->slug) }}"><span class="mb-1 d-inline-block text-gray-800">{{ $featured_course->courseCategory->title }}</span></a>


                            <!-- Heading -->
                            <div class="position-relative">
                                <a href="{{ route('frontend.course_single', $featured_course->slug) }}" class="d-block stretched-link">
                                ...
                                <div class="row mx-n2 align-items-end">
                                    ...
                                    <div class="col-auto px-2 text-right">
                                        ...
                                        <del class="font-size-sm">{{ currency_converter($featured_course->price) }}</del>
            ...
            <div class="text-center">
                ...
                <a wire:click="load_more" class="btn btn-outline-sienna btn-x-wide lift d-inline-block ">{{ __('transf.btn_load_more_courses') }}
                </a>
                <a href="{{ route('frontend.courses') }}" class="btn btn-outline-sienna btn-x-wide lift d-inline-block d-none">{{ __('transf.btn_view_all_courses') }}
                </a>
                @else
                <a wire:click="load_less" class="btn btn-outline-sienna btn-x-wide lift d-inline-block">{{ __('transf.btn_load_less_courses') }}
                </a>
                <a href="{{ route('frontend.courses') }}" class="btn btn-outline-sienna btn-x-wide lift d-inline-block d-none">{{ __('transf.btn_view_all_courses') }}
                </a>
                @endif
